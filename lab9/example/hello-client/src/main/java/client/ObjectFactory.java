...
public class ObjectFactory {
    ...
    private final static QName _GetEmployeeResponse_QNAME = new QName("http://example/", "getEmployeeResponse");
    private final static QName _Count_QNAME = new QName("http://example/", "count");
    private final static QName _GetEmployee_QNAME = new QName("http://example/", "getEmployee");
    private final static QName _CountResponse_QNAME = new QName("http://example/", "countResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example/", name = "getEmployeeResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example/", name = "count")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example/", name = "getEmployee")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example/", name = "countResponse")
