 ...
 * 
 */
@WebServiceClient(name = "EmployeeServiceImplService", targetNamespace = "http://example/", wsdlLocation = "http://localhost:8080/hello-server-1.0-SNAPSHOT/EmployeeServiceImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICEIMPLSERVICE_QNAME = new QName("http://example/", "EmployeeServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/hello-server-1.0-SNAPSHOT/EmployeeServiceImpl?wsdl");
     ...
     * 
     * @return
     *     returns EmpleeService
     */
    @WebEndpoint(name = "EmployeeServiceImplPort")
    public EmpleeService getEmployeeServiceImplPort() {
        return super.getPort(new QName("http://example/", "EmployeeServiceImplPort"), EmpleeService.class);
    }
     ...
     */
    @WebEndpoint(name = "EmployeeServiceImplPort")
    public EmpleeService getEmployeeServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://example/", "EmployeeServiceImplPort"), EmpleeService.class, features);
    }
